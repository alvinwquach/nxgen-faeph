...
function Login() {
  ...
  return (
    <div className="hero-sheen flex min-h-screen items-center justify-center bg-background px-4 py-10">
        ...
        <Card className="border-border bg-card shadow-brand">
          ...
          <CardContent className="space-y-5">
            ...
            <p className="text-center text-sm text-muted-foreground">
              No account yet? <Link to="/signup" className="font-medium text-primary hover:underline">Sign up</Link>
            </p>
          </CardContent>
        </Card>
      </div>
