/**
 * FAE Court Website — single source of truth for sports, courts, rates,
 * contact details, network programs and membership tiers.
...
export const SPORTS: Record<SportKey, Sport> = {
  basketball: {
    ...
    courts: [{ id: "bb-full", name: "Full court", memberRate: 1000, nonMemberRate: 1200 }],
  },
  volleyball: {
    key: "volleyball",
    label: "Volleyball",
    ...
    courts: [{ id: "vb-1", name: "Indoor court", memberRate: 1000, nonMemberRate: 1200 }],
  },
  pickleball: {
    key: "pickleball",
    label: "Pickleball",
...
/** Product name for the site itself. The physical venue stays "F.A.E. Court". */
export const SITE_NAME = "FAE Bookings";
...
export const FAQ: FaqItem[] = [
  { question: "How do I book a court?", answer: "Create an account, go to the Book page, pick your sport, surface, date and time slots. Pay at the counter when you arrive." },
  { question: "What's the cancellation policy?", answer: "Free cancellation up to 6 hours before your slot. Later cancellations are charged in full." },
  { question: "Do I need to bring my own ball?", answer: "Basketball and volleyball — yes, bring your own. Pickleball — paddles and balls are included with every booking." },
  { question: "How does membership work?", answer: "Pay ₱1,000 once a year, get an RFID band, and every court on the floor drops to the member rate. You also get 5% off Filam Elite training." },
