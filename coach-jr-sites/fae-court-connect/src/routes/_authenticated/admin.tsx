...
import { CafeAdmin } from "@/components/fae/CafeAdmin";
...
type AdminTab = "overview" | "gaming" | "bookings" | "requests" | "schedule" | "inventory" | "clients" | "tabs" | "wifi" | "payments" | "settings";

const ADMIN_TABS: { key: AdminTab; label: string; icon: string }[] = [
  { key: "overview", label: "Overview", icon: "chart" },
  { key: "gaming", label: "Gaming Lounge", icon: "monitor" },
